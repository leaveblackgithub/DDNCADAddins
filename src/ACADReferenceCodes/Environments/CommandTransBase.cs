...
{
    public abstract class CommandTransBase : DisposableClass
    {
        ...
        {
            BlockTableRecord btr = GetObjectForWrite(blockTableRecordId) as BlockTableRecord;
        ...
        public void AddEntsToBlockTableRecord(IEnumerable<Entity> ents, ObjectId blockTableRecordId)
        {
            ...
            {
                AddEntToBlockTableRecord(ent,blockTableRecordId);
            }
        }
        ...
        {
            BlockTableRecord btr = GetObjectForRead(btrId) as BlockTableRecord;
        ...
        {
            ObjectId newbtrId = DuplicateBlockDef(bref.BlockTableRecord, newname);
