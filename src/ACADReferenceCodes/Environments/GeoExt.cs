...
namespace CADAddins.Environments
{
    ...
    {
        public static ObjectId BulgeVertexCollectionToPolyline(this BulgeVertexCollection bulgeVertexCollection, ObjectId ownerId, CommandTransBase cmdTransBase)
        {
        ...
        public static ObjectId Line2DToDbLine(this LineSegment2d line2d, Plane plane, ObjectId ownerId,CommandTransBase cmdTransBase)
        {
        ...
        public static ObjectId Spline2DToDbSpline(this NurbCurve2d spline2d, Plane plane, ObjectId ownerId,CommandTransBase cmdTransBase)
        {
        ...
        public static ObjectId Curve2DToDbCurve(this Curve2d cv, Plane plane, ObjectId ownerId, CommandTransBase cmdTransBase)
        {
