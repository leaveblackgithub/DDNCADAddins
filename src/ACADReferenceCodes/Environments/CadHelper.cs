...
namespace CADAddins.Environments
{
    internal class CadHelper
    {
        ...
        public static DocHelper CurDocHelper =>
            GetInstance()._curDocHelper ?? (GetInstance()._curDocHelper = new DocHelper(Application.DocumentManager.MdiActiveDocument));
        ...
        {
            internal static CadHelper Instance = new CadHelper();
