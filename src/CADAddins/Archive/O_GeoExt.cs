...
namespace CADAddins.Archive
{
    public static class O_GeoExt
    {
        ...
        public static ObjectId Line2DToDbLine(this LineSegment2d line2d, Plane plane, ObjectId ownerId,
            O_CommandTransBase cmdTransBase)
        {
            ...
            O_CommandTransBase oCommandTransBase)
        {
                       ...
                       ellipse2d.EndAngle))
            {
                ...
                oCommandTransBase.AddEntToBlockTableRecord(ent, ownerId);
                return ent.Id;
            }
        }
