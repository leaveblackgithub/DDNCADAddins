...
namespace DDNCADAddins.Archive
{
    internal class O_CadHelper
    {
        ...
        public static O_DocHelper CurDocHelper =>
            GetInstance()._curDocHelper ?? (GetInstance()._curDocHelper =
                new O_DocHelper(Application.DocumentManager.MdiActiveDocument));
        ...
        {
            internal static readonly O_CadHelper Instance = new O_CadHelper();
